...
In order to upload the CROSSCON SoC's bitstream to the Arty-A7, you need to install Vivado Lab that is available [here](https://www.xilinx.com/support/download.html).
